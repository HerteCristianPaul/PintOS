...
extern struct list sleep_list;                                    // XXX
               ...
               thread_func *function, void *aux) 
{
  ...
  intr_set_level (old_level); /*setam nivelul de intrerupere la cel vechi*/                               // XXX
...
thread_unblock (struct thread *t) 
{
  ...
  list_sort (&ready_list, cmp_priority, NULL);//sorts the list base of compare priority XXX
...
thread_yield (void) 
{
  ...
  if (cur != idle_thread) {
      ...
      list_sort (&ready_list, cmp_priority, NULL);                  // XXX
  }
...
/* Sets the current thread's priority to NEW_PRIORITY. */       // XXX
void
...
thread_get_nice (void) 
{
  /* Not yet implemented. */
  //return 0;
  return thread_current()->nice;                // XXX
}
...
thread_get_load_avg (void) 
{
  /* Not yet implemented. */
  //return 0;
  return tointround(mulin(load_avg,100));               // XXX
}
...
thread_get_recent_cpu (void) 
{
  /* Not yet implemented. */
  //return 0;
  return tointround(mulin(thread_current()->recent_cpu,100)) ;                  // XXX
}

